<template>
    <div>
        ...
        <router-link :to="{name: 'admin.instation.create'}" class="btn btn-success">Create</router-link>
        ...
        <table class="table table-striped table-dark">
            ...
            <tbody>
                <tr v-for="row in this.elements">
                    ...
                    <td>
                        <router-link :to="{name:'admin.instation.edit', params:{id: row.id} }" class="btn btn-success">edit</router-link>
                    </td>
                    <td>
...
export default {
    ...
    methods: {
        ...
        deleteElement(id) {
            axios.delete(`/api/admin/instations/${id}`)
                .then(res => {
