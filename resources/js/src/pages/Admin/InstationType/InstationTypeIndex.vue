<template>
    <div>
        ...
        <router-link :to="{name: 'admin.instation.types.create'}" class="btn btn-success">Create</router-link>
        ...
        <table class="table table-striped table-dark">
            ...
            <tbody>
                <tr v-for="row in this.elements">
                    ...
                    <td>
                        <router-link :to="{name:'admin.instation.types.edit', params:{id: row.id} }" class="btn btn-success">edit</router-link>
                    </td>
                    <td>
...
export default {
    ...
    mounted() {
        this.get('/api/admin/instation-types');
    },
    methods: {
        async get (link) {
            if (!link) return;
        ...
        deleteElement(id) {
            axios.delete(`/api/admin/instation-types/${id}`)
                .then(res => {
